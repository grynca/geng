...
namespace grynca {
    ...
    inline const std::string& Shader::getLinkingLog() {
        return linking_log_;
    }

    inline const fast_vector<std::string>& Shader::getCompilationLogs() {
    ...
    inline void Shader::setUniform1fv(const std::string& name, f32* value, int count) {
    ...
    inline void Shader::setUniform1iv(const std::string& name, int* value, int count) {
    ...
    inline void Shader::setUniform4fv(const std::string& name, f32* value, int count) {
        setUniform4fv(getUniformLocation_(name), value, count);
    }

    inline void Shader::setUniform3fv(const std::string& name, f32* value, int count) {
    ...
    inline void Shader::setUniform1fv(GLint loc, f32* value, int count) {
    ...
    inline void Shader::setUniform1iv(GLint loc, int* value, int count) {
    ...
    inline void Shader::setUniform4fv(GLint loc, f32* value, int count) {
        GLCall(glUniform4fv(loc, count, value));
    }

    inline void Shader::setUniform3fv(GLint loc, f32* value, int count) {
    ...
    inline Shader::Shader(const std::string& name, const std::string& vs_src, const std::string& fs_src, size_t uniforms_size)
     : name_(name)
    {
        ASSERT_M(uniforms_size <= config::SHADER_UNIFORMS_SIZE, "Shader uniforms too large");
